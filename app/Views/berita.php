    ...
    <main>
        ...
        <div class="carousel-overlay">
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <img src="<?= base_url() ?>/public/assets/images/image4.png" class="d-block w-100" alt="Image Carousel 1">
                        <!-- </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <?php
                    foreach ($beritaPenelitian as $key => $value) {
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?= base_url('berita/detail/' . $value['id_berita']) ?>" class="btn" style="background-color:#8F3797; color:#fff; font-family:'Poppins'">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    <?php
                        // Jika $key adalah kelipatan 3 (3 card), tutup baris
                        if ($key % 3 == 2 || $key == count($beritaPenelitian) - 1) {
                            echo '</div>';
                        }
                    }
                    ?>
                ...
                <div class="container">
                    <div class="row mt-5 mb-3">
                        ...
                        <div class="row">
                            <?php
                            foreach ($beritaKegiatan as $key => $value) {
                                // Jika $key adalah kelipatan 3 (3 card), buat baris baru
                                if ($key % 3 == 0) {
                                    echo '<div class="row">';
                                }
                            ...
                            <?php
                                // Jika $key adalah kelipatan 3 (3 card), tutup baris
                                if ($key % 3 == 2 || $key == count($beritaKegiatan) - 1) {
                                    echo '</div>';
                                }
                            }
                            ?>
