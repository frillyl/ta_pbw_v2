<div class="container">
                    ...
                    foreach ($visi as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#info<?= $value['id_visi'] ?>"><i class="fa-solid fa-circle-info"></i></button>
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $value['id_visi'] ?>"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete<?= $value['id_visi'] ?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <?php foreach ($visi as $key => $value) { ?>
        <div class="modal fade" id="info<?= $value['id_visi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo form_open_multipart('admin/profil/visi/add');
                    ?>
    ...
    <!-- Modal Edit -->
    <?php foreach ($visi as $key => $value) { ?>
        <div class="modal fade" id="edit<?= $value['id_visi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <?php
                        echo form_open_multipart('admin/profil/visi/edit/' . $value['id_visi']);
                        ?>
                        <div class="form-group">
                            <label for="id_user" hidden><b>Dibuat Oleh</b></label>
    ...
    <!-- Modal Delete -->
    <?php foreach ($visi as $key => $value) { ?>
        <div class="modal fade" id="delete<?= $value['id_visi'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('admin/profil/visi/delete/' . $value['id_visi']) ?>" class="btn btn-danger">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
