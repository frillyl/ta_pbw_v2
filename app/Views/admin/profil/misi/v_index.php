<div class="container">
                    ...
                    foreach ($misi as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#info<?= $value['id_misi'] ?>"><i class="fa-solid fa-circle-info"></i></button>
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?= $value['id_misi'] ?>"><i class="fa fa-pencil"></i></button>
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete<?= $value['id_misi'] ?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
    ...
    <?php foreach ($misi as $key => $value) { ?>
        <div class="modal fade" id="info<?= $value['id_misi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo form_open_multipart('admin/profil/misi/add');
                    ?>
    ...
    <!-- Modal Edit -->
    <?php foreach ($misi as $key => $value) { ?>
        <div class="modal fade" id="edit<?= $value['id_misi'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <?php
                        echo form_open_multipart('admin/profil/misi/edit/' . $value['id_misi']);
                        ?>
                        <div class="form-group">
                            <label for="id_user" hidden><b>Dibuat Oleh</b></label>
                            <input type="text" name="id_user" class="form-control" id="id_user" placeholder="<?= session('nm_user') ?>" value="<?= $value['id_user'] ?>" hidden>
                        </div>
                        <div class="form-group mt-2">
                            <label for="isi"><b>Isi</b></label>
    ...
    <!-- Modal Delete -->
    <?php foreach ($misi as $key => $value) { ?>
        <div class="modal fade" id="delete<?= $value['id_misi'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('admin/profil/misi/delete/' . $value['id_misi']) ?>" class="btn btn-danger">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
