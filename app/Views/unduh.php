...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/public/assets/css/style4.css">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="<?= base_url('unduh') ?>" style="color: #B642C0; border-bottom: 4px solid #B642C0; padding-bottom: 2px;">Unduh</a>
                        </li>
                        <li class="nav-item dropdown">
    ...
    <main>
        ...
        <div class="carousel-overlay">
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <img src="<?= base_url() ?>/public/assets/images/image10.png" class="d-block w-100" alt="Image Carousel 1">
                    </div>
                </div>
            </div>
            ...
            <div class="logo-and-text">
                <div class="text-container">
                    <h2 id="judul-penelitian">UNDUH</h2>
                </div>
            </div>
            <!-- CAROUSEL END -->
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <tbody>
                            ...
                            foreach ($unduh as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><?= $value['nm_user'] ?></td>
                                    <td>
                                        <a href="<?= base_url('public/assets/docs/' . $value['file']) ?>" download>Unduh Disini</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    ...
                    <div class="pagination-container">
                        <p class="pagination-info">Menampilkan 1 hingga 10 dari 140 dokumen</p>
