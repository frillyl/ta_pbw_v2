            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <img src="<?= base_url() ?>/public/assets/images/image 8.png" class="d-block w-100" alt="Image Carousel 1">
                        <!-- </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center d-flex align-items-center">
                                <h5 class="fs-2 me-3">Struktur Organisasi</h5>
                                <div class="garis"></div>
                            </div>
                            <div class="row mt-2"></div>
                            <div class="organizational-structure">
                                <img src="<?= base_url() ?>/public/assets/images/image9.png" alt="Deskripsi Gambar">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid" style="background-color: #833A8A; color:#fff">
        <footer class="row-cols-1 py-5 my-5 border-top">
            ...
            <div class="row footer-container">
                <div class="col-lg-12">
                    <h5 style="font-family:'Libre Baskerville'; color: #FFFF;">Media Sosial</h5>
                    <p>
