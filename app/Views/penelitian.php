...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/public/assets/css/style5.css">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" style="color: #B642C0; border-bottom: 4px solid #B642C0; padding-bottom: 2px;" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <main>
        ...
        <div class="carousel-overlay">
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <img src="<?= base_url() ?>/public/assets/images/image12.png" class="d-block w-100" alt="Image Carousel 1">
                    </div>
                </div>
            </div>
            ...
            <div class="logo-and-text">
                <div class="text-container">
                    <h2 id="judul-penelitian">PENERIMA HIBAH PENELITIAN</h2>
                </div>
            </div>
            <!-- CAROUSEL END -->
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($value['skema_penelitian'] == 1) { ?>
                                        ...
                                        <?php } else { ?>
                                            PTKN
                                        <?php } ?></td>
                                    <td style="text-align: left"><?= $value['judul_penelitian'] ?></td>
