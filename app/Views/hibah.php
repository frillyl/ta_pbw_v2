            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <img src="./assets/images/image12.png" class="d-block w-100" alt="Image Carousel 1">
                    </div>
                </div>
            </div>
                    ...
                    <table class="table center-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:left">Ari Wijaya Basuki Raharjo</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Baru</td>
                                ...
                                <td style="text-align:left">Armaini Akhirson</td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>Baru</td>
                                <td style="text-align:left">PDD/Dosen Pemula</td>
                                <td style="text-align:left">Pemanfaatan Teknologi Digital untuk Meningkatkan Daya Saing UMKM Kota Depok </td>
                                <td style="text-align:left">Edy Prihantoro</td>
                            </tr>
                        </tbody>
                    </table>
